...
def main() -> None:
    ...
    updater = Updater("7462588816:AAGy1ypZmxsusKW0rHY8mzMDsAJKekiWPHk", use_context=True)
    ...
    # Configura el JobQueue
    jq = updater.job_queue
    jq.run_repeating(enviar_mensaje_periodico, interval=3600, first=0)
